...
Every name, every sprite and every sound in The Ember Watch is its own. See
...
tools/         the single-file bundler, and the guard rails:
               ...
               check-hero.js  the survivor: nothing clipped by its own frame,
                              ...
                              out-valuing the ground they stand on
...
The Ember Watch is original work. Its setting, roster, bestiary, spell list and
