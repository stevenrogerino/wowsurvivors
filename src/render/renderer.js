...
(function (WS) {
  ...
  R.adaptResolution = function (dtMs) {
    ...
    if (!WS.Game.running) { this._rsSlow = this._rsFast = 0; return; }
    ...
    if (this._rsSlow > 1200 && this.renderScale > RS_MIN) next = WS.max(RS_MIN, this.renderScale * 0.82);
    else if (this._rsFast > 6000 && this.renderScale < 1) next = WS.min(1, this.renderScale * 1.1);
