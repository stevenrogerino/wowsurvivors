  ...
  WS.Finales = {
    thornhollow: {
      ...
      tuning: {
        ...
        drillDamage: 48, drillWindup: 1.1, drillTime: 0.9, drillRange: 560,
    ...
    ochre: {
      ...
      tuning: {
        ...
        destructTime: 7, destructDamage: 400,
        stompDamage: 46, stompRadius: 76, stompTele: 0.9,
        beamDamage: 42, beamTele: 1.4, beamSpin: 0.55, beamTime: 4.5, beamWidth: 46,
        fenceDamage: 30, missileDamage: 40, missileRadius: 70, missileTele: 1.2,
        karrash: 5,
      },
    },
    ...
    palewastes: {
      ...
      tuning: {
        ...
        ventDamage: 44, ventSpin: 0.6, ventTele: 1.2,
        shardReduce: 0.40, shardEvery: 30, winterAt: 0.40, winterEnrage: 100,
        novaDamage: 50, novaSpeed: 190, novaGap: 30,
        gridDamage: 56, gridTele: 1.5, spikeDamage: 40,
        ghouls: 10,
      },
    },
  };
